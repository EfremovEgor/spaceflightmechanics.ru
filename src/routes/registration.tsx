...
function RouteComponent() {
  const [modalState, setModalState] = useState<null | "submission" | "success">(
    null,
  );
  return (
    <BasePageLayout name="Registration">
      ...
      >
        <div className="min-w-[300px] md:min-w-[600px] lg:min-w-[800px] text-2xl flex flex-col justify-center items-center ">
          ...
          />
          <p>
            You have successfully registered to the 7<sup>th</sup> SciTech
            Forum!
          </p>
        </div>
      </Modal>
      <p>
        All categories of participants need to register to the 7th SciTech Forum
        using the application below. After registration the confirmation email
        with Zoom link will be sent.
      </p>
